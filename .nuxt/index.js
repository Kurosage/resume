...
import nuxt_plugin_plugin_468556d8 from 'nuxt_plugin_plugin_468556d8' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_pluginrouting_5080dfbc from 'nuxt_plugin_pluginrouting_5080dfbc' // Source: .\\nuxt-i18n\\plugin.routing.js (mode: 'all')
import nuxt_plugin_pluginmain_36661e8d from 'nuxt_plugin_pluginmain_36661e8d' // Source: .\\nuxt-i18n\\plugin.main.js (mode: 'all')
import nuxt_plugin_pluginserver_f901975c from 'nuxt_plugin_pluginserver_f901975c' // Source: .\\color-mode\\plugin.server.js (mode: 'server')
import nuxt_plugin_pluginclient_1dc5c2ca from 'nuxt_plugin_pluginclient_1dc5c2ca' // Source: .\\color-mode\\plugin.client.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_468556d8 === 'function') {
    await nuxt_plugin_plugin_468556d8(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginrouting_5080dfbc === 'function') {
    await nuxt_plugin_pluginrouting_5080dfbc(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginmain_36661e8d === 'function') {
    await nuxt_plugin_pluginmain_36661e8d(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_f901975c === 'function') {
    await nuxt_plugin_pluginserver_f901975c(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_1dc5c2ca === 'function') {
    await nuxt_plugin_pluginclient_1dc5c2ca(app.context, inject)
  }
