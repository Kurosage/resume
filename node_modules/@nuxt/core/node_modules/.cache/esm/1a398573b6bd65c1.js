let resolve,fsp,defu,template,addTemplates;_b6b‍.x([["default",()=>_b6b‍anonymous]]);_b6b‍.w("path",[["resolve",["resolve"],function(v){resolve=v}]]);_b6b‍.w("fs",[["promises",["fsp"],function(v){fsp=v}]]);_b6b‍.w("defu",[["default",["defu"],function(v){defu=v}]]);_b6b‍.w("lodash.template",[["default",["template"],function(v){template=v}]]);_b6b‍.w("./utils",[["addTemplates",["addTemplates"],function(v){addTemplates=v}]]);





               async function  _b6b‍anonymous(moduleOptions) {
  const defaults = {
    preference: 'system',
    fallback: 'light',
